...
import 'package:waste_management_admin/domain/repositories/stream_completed_collection.dart';
...
class CompletedCollection extends StatelessWidget {
  CompletedCollection({super.key, required this.index});
  int index;
  @override
      ...
      body: Container(
        ...
        child: SafeArea(
          child: StreamBuilder<List<WeeklyCollection>>(
              stream: streamAllCompletedCollection(index),
                  ...
                  return Column(
                    ...
                    children: [
                      Padding(
                        ...
                        child: const BackButtonCustomMade(),
                      ),
                      Expanded(
                          child: GroupedListView<WeeklyCollection, DateTime>(
                              ...
                              groupHeaderBuilder: (WeeklyCollection element) {
                                return Padding(
